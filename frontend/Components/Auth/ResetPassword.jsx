          ...
          <AnimatePresence mode="wait">
            {!isSuccess ? (
              ...
              >
                ...
                <div>
                  <label htmlFor="reset-otp" className="block text-xs font-bold text-ink uppercase tracking-wider mb-2">Verification Matrix OTP</label>
                  <input
                    id="reset-otp"
                    type="text"
                    inputMode="numeric"
                ...
                <div className="relative">
                  <label htmlFor="reset-new-password" className="block text-xs font-bold text-ink uppercase tracking-wider mb-2">New Access Key</label>
                  <div className="relative">
                    <input
                ...
                <div className="relative">
                  <label htmlFor="reset-confirm-password" className="block text-xs font-bold text-ink uppercase tracking-wider mb-2">Confirm Access Key</label>
                  <div className="relative">
                    <input
